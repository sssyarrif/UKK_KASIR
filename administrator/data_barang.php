...
<div class="card mt-2">
    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <div class="modal fade" id="edit-data<?php echo $d['ProdukID'];?>" tabinex="-1" aria-labelledby="exampleModelLabel" aria-hidden="true">
            ...
            <div class="modal fade" id="hapus-data<?php echo $d['ProdukID'];?>" tabinex="-1" aria-labelledby="exampleModelLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
